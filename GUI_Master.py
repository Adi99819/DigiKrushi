...
root.title("  Soil Classification & Suggest  Crop Life Cycle ")

# 43

# ++++++++++++++++++++++++++++++++++++++++++++
#####For background Image
image2 = Image.open('gu.jpg')
...
#
label_l2 = tk.Label(root, text="Soil Classification & Suggest  Crop Life Cycle ",font=("times", 30, 'bold'),
                    background="#DC143C", fg="white", width=55, height=2)
...
def openimage():
    ...
    global fn
    fileName = askopenfilename(initialdir='E://50 % code soil//dataset', title='Select image for Aanalysis ',
                               filetypes=[("all files", "*.*")])
    IMAGE_SIZE=200
    imgpath = fileName
    fn = fileName
...
label_l1 = tk.Label(root, text="** Diabetic retinopathy detection _____  **",font=("Times New Roman", 10, 'bold'),
